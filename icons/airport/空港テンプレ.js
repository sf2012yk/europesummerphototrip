...
//  空港名
    ...
    <a href="画像URLを貼る" 
       data-lightbox="image" 
       data-title="空港名">
      <img class="popup_img" loading="eager" src="画像URLを貼る" alt="空港名 Airport">
    </a>
    <div class="popup_caption">
    <a href="画像URLを貼る" data-lightbox="image" data-title="空港名 Airport" class="popup_link">空港名 Airport</a>
    <p>
    空港名の説明
    </p>
    </div>
